...
Le service Web reprend l'organisation du site B sur le réseau applicatif de travail `172.16.74.0/24`, inclus dans le bloc Site 2 `172.16.64.0/18`.

| Rôle | Adresse | Passerelle |
| --- | --- | --- |
| Reverse proxy | `172.16.74.10/24` | `172.16.74.1` |
| Web 1 | `172.16.74.11/24` | `172.16.74.1` |
| Web 2 | `172.16.74.12/24` | `172.16.74.1` |
